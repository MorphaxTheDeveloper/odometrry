...
//import frc.robot.commandgroups.Autonomous.ThreeBalls.Blue322;
//import frc.ralobot.commandgroups.Autonomous.TwoBalls.Blue21;
//import frc.robot.commandgroups.Autonomous.TwoBalls.Red21;
import frc.robot.commandgroups.Autonomous.TwoBalls.TEST;
import frc.robot.commandgroups.Autonomous.TwoBalls.new2ballz;
...
public class RobotContainer {
  ...
  //tanımlama hatası olabilir.
public ScorpTrajectory3 m_scorp;
...
//new Trigger(() -> !m_feeder.isBallIn())
 //.whenActive(
  ...
  //.withInterrupt((() -> m_feeder.getSwitchValue() || xstick.getRawButton(2))));

stickButton11.whileHeld(new tankdrive(m_drive));
...
X_Button.whenPressed(new FeederTurn(m_feeder, -1));
  ...
  public Command getAutonomousCommand(int mode) {
    ...
    if (alliance == "Blue") {
      switch (mode) {
        ...
        case 1:
          return new TEST(m_drive, m_feeder, m_intake, m_shooter, m_vision, m_led);
        ...
        case 2:
         ...
         case 3:
          return new ScorpTrajectory3(m_drive,m_scorp).ramseteGenerator();
