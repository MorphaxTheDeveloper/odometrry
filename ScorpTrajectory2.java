...
public class ScorpTrajectory2 {
  ...
  public Trajectory cem = new Trajectory();
  ...
  public ScorpTrajectory2(DriveSubsystem m_drive) {
    this.m_drive = m_drive;
     ...
     //cem = TrajectoryGenerator.generateTrajectory(
      //List.of(
...
/*cem = TrajectoryGenerator.generateTrajectory(
      List.of(new Pose2d(1.0, 0, new Rotation2d(0))),
      config);
  ...
  //   Path Blue2BallsPosition1 =
   ...
   //try {
    ...
    //} catch (IOException e) {
     // e.printStackTrace();
      //SmartDashboard.putString("error", "path is not valid.");
    //}
    //dikkat
  }
